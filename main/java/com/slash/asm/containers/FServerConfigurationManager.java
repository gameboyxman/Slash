...
public class FServerConfigurationManager extends net.minecraft.server.management.ServerConfigurationManager
{

	public FServerConfigurationManager(MinecraftServer minecraftServer)
	{
	...
	{		
		...
		// super.func_72381_a(par2EntityPlayerMP, (EntityPlayerMP)null,
		// worldserver);
